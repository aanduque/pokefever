...
use function Pokefever\get_registered_post_types;
...
<div class="container" id="list">
	...
	<?php
	foreach ( get_registered_post_types() as $pokefever_registered_post_type ) :
		list( $slug, $args ) = $pokefever_registered_post_type;
		?>
