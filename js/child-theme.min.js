...
/*!
	  ...
	  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
	  */
!function(e,t){e.exports=function(e,t,n,i){const s=e=>e&&"object"==typeof e&&"default"in e?e:{default:e},o=s(t),r=s(n),a="toast",l=".bs.toast",c=`mouseover${l}`,u=`mouseout${l}`,d=`focusin${l}`,f=`focusout${l}`,h=`hide${l}`,p=`hidden${l}`,g=`show${l}`,m=`shown${l}`,_="fade",b="hide",v="show",y="showing",w={animation:"boolean",autohide:"boolean",delay:"number"},x={animation:!0,autohide:!0,delay:5e3};class E extends r.default{constructor(e,t){super(e,t),this._timeout=null,this._hasMouseInteraction=!1,this._hasKeyboardInteraction=!1,this._setListeners()}static get Default(){return x}static get DefaultType(){return w}static get NAME(){return a}show(){if(o.default.trigger(this._element,g).defaultPrevented)return;this._clearTimeout(),this._config.animation&&this._element.classList.add(_);const t=()=>{this._element.classList.remove(y),o.default.trigger(this._element,m),this._maybeScheduleHide()};this._element.classList.remove(b),e.reflow(this._element),this._element.classList.add(v,y),this._queueCallback(t,this._element,this._config.animation)}hide(){if(!this.isShown())return;if(o.default.trigger(this._element,h).defaultPrevented)return;const e=()=>{this._element.classList.add(b),this._element.classList.remove(y,v),o.default.trigger(this._element,p)};this._element.classList.add(y),this._queueCallback(e,this._element,this._config.animation)}dispose(){this._clearTimeout(),this.isShown()&&this._element.classList.remove(v),super.dispose()}isShown(){return this._element.classList.contains(v)}_maybeScheduleHide(){this._config.autohide&&(this._hasMouseInteraction||this._hasKeyboardInteraction||(this._timeout=setTimeout((()=>{this.hide()}),this._config.delay)))}_onInteraction(e,t){switch(e.type){case"mouseover":case"mouseout":this._hasMouseInteraction=t;break;case"focusin":case"focusout":this._hasKeyboardInteraction=t}if(t)return void this._clearTimeout();const n=e.relatedTarget;this._element===n||this._element.contains(n)||this._maybeScheduleHide()}_setListeners(){o.default.on(this._element,c,(e=>this._onInteraction(e,!0))),o.default.on(this._element,u,(e=>this._onInteraction(e,!1))),o.default.on(this._element,d,(e=>this._onInteraction(e,!0))),o.default.on(this._element,f,(e=>this._onInteraction(e,!1)))}_clearTimeout(){clearTimeout(this._timeout),this._timeout=null}static jQueryInterface(e){return this.each((function(){const t=E.getOrCreateInstance(this,e);if("string"==typeof e){if(void 0===t[e])throw new TypeError(`No method named "${e}"`);t[e](this)}}))}}return i.enableDismissTrigger(E),e.defineJQueryPlugin(E),E}(r(),c(),w(),A())}(Qt);var Kt,Ut,Xt,Yt=Qt.exports;Kt=navigator.userAgent.toLowerCase().indexOf("webkit")>-1,Ut=navigator.userAgent.toLowerCase().indexOf("opera")>-1,Xt=navigator.userAgent.toLowerCase().indexOf("msie")>-1,(Kt||Ut||Xt)&&document.getElementById&&window.addEventListener&&window.addEventListener("hashchange",(function(){var e,t=location.hash.substring(1);/^[A-z0-9_-]+$/.test(t)&&(e=document.getElementById(t))&&(/^(?:a|select|input|button|textarea)$/i.test(e.tagName)||(e.tabIndex=-1),e.focus())}),!1);var Jt,Gt=function(){var e=document.getElementById("filter");null==e||e.addEventListener("submit",(function(t){var n,i;t.preventDefault();var s=null===(n=document.activeElement)||void 0===n?void 0:n.getAttribute("name"),o=e.parentElement;o&&(o.style.transition="opacity 0.5s ease-in-out",o.classList.add("opacity-50"));var r=new FormData(e),a=new URL(null!==(i=null==e?void 0:e.action)&&void 0!==i?i:"");a.search="",fetch(a,{method:"POST",body:r}).then((function(e){return e.text()})).then((function(e){var t,n,i=null!==(t=(new DOMParser).parseFromString(e,"text/html").getElementById("list"))&&void 0!==t?t:null;i?(document.getElementById("list").innerHTML=i.innerHTML,Gt()):s&&(null===(n=document.getElementsByName(s)[0])||void 0===n||n.focus());o&&(o.style.transition="opacity 0.5s ease-in-out",o.classList.remove("opacity-50"))})).catch((function(e){}))}))};Jt=Gt,"undefined"!=typeof document&&("complete"!==document.readyState&&"interactive"!==document.readyState?document.addEventListener("DOMContentLoaded",Jt):Jt()),jQuery((function(e){e("#load-oldest-pokedex-number").on("click",(function(t){t.preventDefault(),e("#load-oldest-pokedex-number").hide(0),e("#oldest-pokedex-number").show(0);var n={action:"load_oldest_pokedex_number",post_id:pokefever.current_post_id,_ajax_nonce:pokefever.nonce};e.post(pokefever.ajax_url,n).done((function(t){e("#oldest-pokedex-number").html(t)})).fail((function(t){e("#oldest-pokedex-number").html(pokefever.messages[t.status]),setTimeout((function(){e("#oldest-pokedex-number").hide(0),e("#load-oldest-pokedex-number").show(0)}),3e3)}))}))})),e.Alert=T,e.Button=k,e.Carousel=I,e.Collapse=M,e.Dropdown=vt,e.Modal=Lt,e.Offcanvas=jt,e.Popover=Bt,e.Scrollspy=zt,e.Tab=Vt,e.Toast=Yt,e.Tooltip=Rt}));
